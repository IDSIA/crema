...
public class StridesTest {
	...
	public void testGetOffset() {
		Strides s1 = new Strides(new int[]{0, 1, 2}, new int[]{2, 2, 3});
		assertEquals(0, s1.getOffset(0, 0, 0));
		assertEquals(s1.getCombinations() - 1, s1.getOffset(1, 1, 2));
		assertEquals(1, s1.getOffset(1, 0, 0));
		assertEquals(2, s1.getOffset(0, 1, 0));
		assertEquals(4, s1.getOffset(0, 0, 1));
		assertEquals(8, s1.getOffset(0, 0, 2));
		assertEquals(9, s1.getOffset(1, 0, 2));
		assertEquals(10, s1.getOffset(0, 1, 2));
	}
