...
public abstract class ExpectationMaximization<F extends Factor<F>> {
	...
	protected Inference<GraphicalModel<F>, F> inferenceEngine;
	...
	public ExpectationMaximization<F> setInferenceEngine(Inference<GraphicalModel<F>, F> inferenceEngine) {
